(function(b) {
    var a = (function() {
        return false === b.support.boxModel && b.support.objectAll && b.support.leadingWhitespace
    })();
        ...
        if (b.isFunction(this.each)) {
            ...
            return this.each(function() {
                ...
                if (b(this).data("jGrowl.instance") == undefined) {
                    b(this).data("jGrowl.instance", b.extend(new b.fn.jGrowl(), {notifications: [], element: null, interval: null}));
    ...
    b.extend(b.fn.jGrowl.prototype, {defaults: {pool: 0, header: "", group: "", sticky: false, position: "top-right", glue: "after", theme: "default", themeState: "highlight", corners: "10px", check: 250, life: 3000, closeDuration: "normal", openDuration: "normal", easing: "swing", closer: true, closeTemplate: "&times;", closerTemplate: "<div>[ close all ]</div>", log: function(d, c, f) {
            ...
            var typeIcon = f.negative;
            var icon  = "notification-icon";
            
            if(typeIcon != null && typeIcon == true){
                icon = "notification-icon-negative";
                
            }
            var typeBackground = f.background;
            var background = "";
            if(typeBackground != null && typeBackground == "red"){
                background = "notification-error";
            }else if(typeBackground != null && typeBackground == "green"){
                background = "notification-success";
            }
            //alert(ssd);
            //var e = b('<div class="notification jGrowl-notification ' + f.themeState + ((f.group != undefined && f.group != "") ? " " + f.group : "") + '"><span class="notification-icon"></span><span class="closebox">' + f.closeTemplate + "</span><h3>" + f.header + '</h3><div class="jGrowl-message">' + d + "</div></div>").data("jGrowl", f).addClass(f.theme).children("span.closebox").bind("click.jGrowl", function() {
            var e = b('<div class="notification '+background+' jGrowl-notification ' + f.themeState + ((f.group != undefined && f.group != "") ? " " + f.group : "") + '"><span class="'+icon+'"></span><span class="closebox">' + f.closeTemplate + "</span><h3>" + f.header + '</h3><div class="jGrowl-message">' + d + "</div></div>").data("jGrowl", f).addClass(f.theme).children("span.closebox").bind("click.jGrowl", function() {
            ...
            b(this.element).removeClass("jGrowl").find("div.jGrowl-notification").trigger("jGrowl.close").parent().empty()
        }, close: function() {
